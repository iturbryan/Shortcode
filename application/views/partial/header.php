...
<head>
	<meta charset="utf-8">
	<title>SMS API - <?php echo $title; ?></title>
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.1/themes/smoothness/jquery-ui.css">
  ...
  <script src="//code.jquery.com/ui/1.11.1/jquery-ui.js"></script>
	...
	<script src="<?php echo base_url(); ?>media/js/highcharts-custom.js"></script>
...
<div id="header">
  <div class="row">
	...
	<div class="col-xs-12 col-md-10 right">
	  <h1>SMS API - ZETU MOBILE</h1>
	  <div class="row">
	    <div class="col-md-7">
		...
		<ul class="dropdown-menu .dropdown-menu-right btn-lng btn-block right" role="menu" aria-labelledby="dropdownMenu1">
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control">Dashboard&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/dashboard.png" /></a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control/send">Send SMS&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/comments.png" /></a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control/outbox">SMS Outbox&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/parcel_types.png" /></a></li>
		  <!--<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control/inbox">SMS Inbox&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/parcel.png" /></a></li>-->
		  <li role="presentation" class="divider"></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control/settings">Configuration Settings&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/settings.png" /></a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control/change">Change Password&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/change.png" /></a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>control/logout">Logout&nbsp;&nbsp;<img src="<?php echo base_url(); ?>media/images/icons/logout.png" /></a></li>
		</ul>
	      </div>
	    </div>
	  </div>
